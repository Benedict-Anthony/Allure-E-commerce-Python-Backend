...
class Asset(models.Model):
    ...
    # products = models.ForeignKey(Products, ondelete=models.SET_NULL, blank=True, null=True)
...
class Lesson(models.Model):
    ...
    slug = models.SlugField(blank=True, null=True, default="", unique=True, max_length=255)
